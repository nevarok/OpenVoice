...
buffer = convert_to_bytes(f'{ckpt_base}/checkpoint.pth')
...
buffer = convert_to_bytes(f'{ckpt_converter}/checkpoint.pth')
...
buffer = convert_to_bytes(f'{ckpt_base}/en_default_se.pth')
